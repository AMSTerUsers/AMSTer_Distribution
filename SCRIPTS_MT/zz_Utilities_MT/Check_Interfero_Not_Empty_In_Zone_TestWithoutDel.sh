...
# and before running MSBAS.sh. It will however not delete the wrong images.
#
...
# New in Distro V 1.3:	- log bad pairs 
#						- set proper double quote in some lines 
...
# New in Distro V 3.2 20240813:	- For Mac OSX, use coreutils fct gnproc instead of sysctl -n hw.ncpu 
#
