...
#mass Process dir
MASSPROCESSASCDIR=$PATH_3601/SAR_MASSPROCESS/S1/ARG_DOMU_LAGUNA_A_18/SMNoCrop_SM_20180512_Zoom1_ML4
MASSPROCESSDESCDIR=$PATH_3601/SAR_MASSPROCESS/S1/ARG_DOMU_LAGUNA_D_83/SMNoCrop_SM_20180222_Zoom1_ML4


# Name of step 1 cron script
CRONSTEP1="Domuyo_S1_Step1_Read_SMCoreg_Pairs.sh"
