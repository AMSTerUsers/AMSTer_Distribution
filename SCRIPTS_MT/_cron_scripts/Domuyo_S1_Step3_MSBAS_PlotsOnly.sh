...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	###################################
		...
		S1ASC=${PATH_3601}/SAR_MASSPROCESS/S1/ARG_DOMU_LAGUNA_A_18/SMNoCrop_SM_20180512_Zoom1_ML4
		S1DESC=${PATH_3601}/SAR_MASSPROCESS/S1/ARG_DOMU_LAGUNA_D_83/SMNoCrop_SM_20180222_Zoom1_ML4
...
# ################################################################################
# 	if [ -s  ${MSBASDIR}/_Last_MassProcessed_Pairs_Time.txt ] 
# 		then   
