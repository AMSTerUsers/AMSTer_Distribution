#!/bin/bash
# Script to run in cronjob for processing DOMUYO images with ETAD data:
...
# New in Distro V 6.0.0 20240530:	- reprocessing with DEM referred to Geoid 
...
#Launch param files
PARAMCOREGASC=$PATH_1650/Param_files/S1/ARG_DOMU_LAGUNA_A_18/LaunchMTparam_S1_Arg_Domu_Laguna_A_18_Zoom1_ML4_MassProc_Coreg_DEMGeoid_ETAD.txt 
PARAMCOREGDESC=$PATH_1650/Param_files/S1/ARG_DOMU_LAGUNA_D_83/LaunchMTparam_S1_Arg_Domu_Laguna_D_83_Zoom1_ML4_MassProc_Coreg_DEMGeoid_ETAD.txt
...
NEWDESCPATH=$PATH_1650/SAR_SM/RESAMPLED/S1/ARG_DOMU_LAGUNA_DEMGeoid_D_83/SMNoCrop_SM_${SMDESC}
