...
# New in Distro V 1.1.0 20251028 :	- add long segments to max 3 shortest baseline plots: 30 days with max 30m
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		TABLESET1=${SET1}/table_0_0_MaxShortest_${MAXSHORT}_Without_Quanrantained_3_months_Plus20Minus10days_Max30m.txt
		TABLESET2=${SET2}/table_0_0_MaxShortest_${MAXSHORT}_Without_Quanrantained_3_months_Plus20Minus10days_Max30m.txt
...
#
	...
	###########################################
		MSBASDIR=${PATH_3610}/MSBAS/_${LABEL}_S1_Auto_Max${MAXSHORT}Shortests_2_months_Plus20Minus10days_Max30m	
