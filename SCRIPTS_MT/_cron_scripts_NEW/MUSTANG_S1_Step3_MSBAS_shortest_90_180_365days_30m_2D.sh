...
# New in Distro V 1.1.0 20251027 :	- add long segments to max 3 shortest baseline plots: 30 days - 180 days and 365 days with max 30m
# New in Distro V 2.0.0 20251028 :	- max 128 threads 
...
#
	...
	###########################################
		MSBASDIR=${PATH_3610}/MSBAS/_${LABEL}_S1_Auto_Max${MAXSHORT}Shortests_3_6_12_months_Plus20Minus10days_Max30m	
