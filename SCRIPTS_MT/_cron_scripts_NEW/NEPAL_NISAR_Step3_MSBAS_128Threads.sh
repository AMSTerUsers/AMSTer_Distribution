...
#
# NOTE: - MSBAS Calibration is disabled because deformation maps are detrended at processing. though may want to set it outside of one of the landslide
#		
#
# Parameters: - none 
#
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		MODE01A="FreqA_A98_LL_Frame16_40Mhz_41deg"
	...
	###########################################
		...
		MSBASDIR=${PATH_3610}/MSBAS/_${LABEL}_NISAR_Auto_${MSBASDIRCRITERIA}
...
#
	...
	#################################################
		...
		TIMESERIESPTSDESCRASC1=${PATH_1650}/Data_Points/Points_TS_${LABEL}_${MODE01A}.txt
	...
	CRONJOB2=${PATHCRONJOB}/NEPAL_NISAR_Step2_MassProc.sh
...
##################################################################
	...
	LASTASC1=`find ${NISARASC1}/Geocoded/${DEFOMODE}/ -maxdepth 1 -type f -name "*deg" -printf "%T+ %p\n" | sort -r | head -1 | ${PATHGNU}/gawk '{print $2}'`
...
# Prepare header files 
		...
		cat ${MSBASDIR}/header_none.txt | ${PATHGNU}/gsed ${LINENR01A}' s/#SET = /SET = /' > ${MSBASDIR}/header_${MODE01A}.txt	# A98
		${PATHGNU}/gsed -i "s/^WINDOW_SIZE.*/WINDOW_SIZE = '${CROP_A98}'/" ${MSBASDIR}/header_${MODE01A}.txt
...
#			restrict_msbas_to_Coh.sh ${DEFOMODE}1 ${COHRESTRICT} ${KMLCOH} ${NISARASC1}/Geocoded/Coh
#			restrict_msbas_to_Coh.sh ${DEFOMODE}2 ${COHRESTRICT} ${KMLCOH} ${NISARASC2}/Geocoded/Coh
#			restrict_msbas_to_Coh.sh ${DEFOMODE}3 ${COHRESTRICT} ${KMLCOH} ${NISARDESC1}/Geocoded/Coh
#			restrict_msbas_to_Coh.sh ${DEFOMODE}4 ${COHRESTRICT} ${KMLCOH} ${NISARDESC2}/Geocoded/Coh
#			restrict_msbas_to_Coh.sh ${DEFOMODE}5 ${COHRESTRICT} ${KMLCOH} ${NISARDESC3}/Geocoded/Coh
#		
