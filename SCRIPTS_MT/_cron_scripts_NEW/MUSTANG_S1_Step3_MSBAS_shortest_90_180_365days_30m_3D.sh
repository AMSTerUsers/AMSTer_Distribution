...
# New in Distro V 2.1.0 20251027 :	- add long segments to max 3 shortest baseline plots: 30 days - 180 days and 365 days with max 30m
# New in Distro V 2.2 20251029 :	- restrict to 128 Threads
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		LABEL=Mustang3D 	# Label for file naming (used for naming zz_ dirs with results and figs etc)
	...
	###################################
		...
		# Tables names
		#TABLESET1=${SET1}/table_0_0_MaxShortest_3.txt
		#TABLESET2=${SET2}/table_0_0_MaxShortest_3.txt
		TABLESET1=${SET1}/table_0_0_MaxShortest_${MAXSHORT}_Without_Quanrantained_3_6_12_months_Plus20Minus10days_Max30m.txt
		TABLESET2=${SET2}/table_0_0_MaxShortest_${MAXSHORT}_Without_Quanrantained_3_6_12_months_Plus20Minus10days_Max30m.txt
	...
	###########################################
		MSBASDIRCRITERIA=Max${MAXSHORT}Shortests_3_6_12_months_Plus20Minus10days_Max30m
