...
AUT="Nicolas d'Oreye, (c)2016-2019, Last modified on Aug 4, 2025"
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		SET1=${PATH_1650}/SAR_SM/MSBAS/BXLMONS/set1
		SET2=${PATH_1650}/SAR_SM/MSBAS/BXLMONS/set2
		...
		LABEL=BxlMons 				# Label for file naming (used for naming zz_ dirs with results and figs etc)
	...
	###################################
		...
		# IW
		S1ASCIW=$PATH_3611/SAR_MASSPROCESS/S1/BXLMONS_A_161/SMNoCrop_SM_${SMASC}_Zoom1_ML2
		S1DESCIW=$PATH_3611/SAR_MASSPROCESS/S1/BXLMONS_D_110/SMNoCrop_SM_${SMDESC}_Zoom1_ML2

		# Path to LaunchParameters.txt files for each mode (need one for each mode)
		LAUNCHPARAMASCIW=LaunchMTparam_S1_IW_BxlMons_A_Zoom1_ML2_MassProc.txt
		LAUNCHPARAMDESCIW=LaunchMTparam_S1_IW_BxlMons_D_Zoom1_ML2_MassProc.txt
	...
	#########################################################################
	CRONJOB2=BXLMONS_S1_Step2_MassProc.sh
