...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	###################################
		...
		PARAMPROCESS07A="$PATH_1650/Param_files/ALOS2/PF/${MODE07A}/LaunchMTparam_ALOS2_${MODE07A}_Full_Zoom1_ML8_MassProc.txt"		# unused because low angle 
		...
		PARAMPROCESS01D="$PATH_1650/Param_files/ALOS2/PF/${MODE01D}/LaunchMTparam_ALOS2_${MODE01D}_Full_Zoom1_ML8_MassProc.txt"		# unused because low angle 
		...
		PARAMPROCESS05D="$PATH_1650/Param_files/ALOS2/PF/${MODE05D}/LaunchMTparam_ALOS2_${MODE05D}_Full_Zoom1_ML8_MassProc.txt"		# empty table
		PARAMPROCESS06D="$PATH_1650/Param_files/ALOS2/PF/${MODE06D}/LaunchMTparam_ALOS2_${MODE06D}_Full_Zoom1_ML8_MassProc.txt"
		PARAMPROCESS07D="$PATH_1650/Param_files/ALOS2/PF/${MODE07D}/LaunchMTparam_ALOS2_${MODE07D}_Full_Zoom1_ML8_MassProc.txt"		# not much data 
		...
		PARAMPROCESS14D="$PATH_1650/Param_files/ALOS2/PF/${MODE14D}/LaunchMTparam_ALOS2_${MODE14D}_Full_Zoom1_ML8_MassProc.txt"		# unused because low angle 	
...
#         restrict_msbas_to_Coh.sh ${DEFOMODE}1 ${COHRESTRICT} ${KMLCOH} ${S1ASC}/Geocoded/Coh
 #        restrict_msbas_to_Coh.sh ${DEFOMODE}2 ${COHRESTRICT} ${KMLCOH} ${S1DESC}/Geocoded/Coh
		...
		${PATH_SCRIPTS}/SCRIPTS_MT/MSBAS.sh "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${TIMESERIESPTS}" --msbasv4_3D
...
#
	...
	TIMESERIESPTS="${PATH_SCRIPTS}/SCRIPTS_MT/_cron_scripts/List_DoubleDiff_EW_UD_${LABEL}.txt"
 	...
 	#x Now msbas single points (with error bars) times series and plots are in dir. Let's add the description to the naming
	cp "${TIMESERIESPTSDESCR}" "${MSBASDIR}"/"zz_${ALLCOMP}_TS_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
