...
DIRSARDATAA98=${PATHDIRSARDATA}/NEPAL/A098_frame016
DIRSARDATAD48=${PATHDIRSARDATA}/NEPAL/D048_frame074
...
# resampled dir
NEWASCPATH1=${RESAMDIR}/NISAR/NEPAL_FreqA_A98_LL_Frame16_40Mhz_41deg/SMNoCrop_SM_${SMASC1}

NEWDESCPATH1=${RESAMDIR}/NISAR/NEPAL_FreqA_D48_LL_Frame74_20Mhz_41deg/SMNoCrop_SM_${SMDESC1}
NEWDESCPATH2=${RESAMDIR}/NISAR/NEPAL_FreqA_D48_LL_Frame74_40Mhz_41deg/SMNoCrop_SM_${SMDESC2}	# Desc48 FreqA LL Frame74 40Mhz 41deg 
...
if [ ! -s ${NEWASCPATH1}/_No_New_Data_Today.txt ] ; then 
	echo "n" | Prepa_MSBAS.sh ${DIRSET}/set11 ${BP} ${BT} ${SMASC1}   > /dev/null 2>&1  &
fi
