#!/bin/bash
# Script intends to run in a cronjob an automatic systematic (re)processing of 3D msbas time 
...
#
# New in Distro V 2.0 20240924:	- rebulit from 2D from same date 
# New in Distro V 2.1 20240925:	- store  timeLine_NS_${COORDLABELNAME12}.txt in /zz_${ALLCOMP}_TS_Auto_${OLL}
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		LABEL=Nepal3D_Bolde 	# Label for file naming (used for naming zz_ dirs with results and figs etc)
	...
	###################################
		...
		LAUNCHPARAMASC=LaunchMTparam_S1_Nepal_TAPGAON_BOLDE_A_85_Zoom1_ML2_MassProc_0keep_MassProc.txt
		LAUNCHPARAMDESC1=LaunchMTparam_S1_Nepal_TAPGAON_BOLDE_D_19_Zoom1_ML2_MassProc_0keep_MassProc.txt
		LAUNCHPARAMDESC2=LaunchMTparam_S1_Nepal_TAPGAON_BOLDE_D_121_Zoom1_ML2_MassProc_0keep_MassProc.txt
		...
		PAIRSTOIGNORE3=${SET3}/_EXCLUDE_PAIRS_ALTHOUGH_CRITERIA_OK.txt
		
	# Events tables
	###############
		#EVENTS=${PATH_1650}/EVENTS_TABLES/${LABEL}
		EVENTS=${PATH_1650}/EVENTS_TABLES/NEPAL
	...
	#########################################################################
	CRONJOB2=Nepal_S1_Step2_MassProc_shortest.sh
	CRONJOB2D=Neopal_S1_Step3_MSBAS_shortest_2D.sh
...
#####################
	...
	mkdir -p ${MSBASDIR}/zz_LOS_TS_A_85_Auto_${ORDER}_${LAMBDA}_${LABEL}/_Time_series
	...
	mkdir -p ${MSBASDIR}/zz_LOS_TS_D_19_Auto_${ORDER}_${LAMBDA}_${LABEL}/_Time_series
	...
	mkdir -p ${MSBASDIR}/zz_LOS_TS_D_121_Auto_${ORDER}_${LAMBDA}_${LABEL}/_Time_series
...
#	${PATH_SCRIPTS}/SCRIPTS_MT/build_header_msbas_criteria.sh DefoInterpolx2Detrend 3 ${BP} ${BT} ${S1ASC} ${S1DESC1} ${S1DESC2}
	...
	${PATHGNU}/gsed -i 's/WINDOW_SIZE = 0, 3381, 0, 1838/WINDOW_SIZE = 2650, 2800, 750, 880/' ${MSBASDIR}/header.txt
...
##########
	...
	#----------------------------------------
 		...
 		then 
			...
			Plot_vectorDispl_DEM.py ${WHEREDEM} ${NSDISPL} ${EWDISPL}  --x_min 2600 --x_max 2850 --y_min 700 --y_max 900
			...
			# Full vector plt
			Plot_vectorDispl_DEM.py ${WHEREDEM} ${NSDISPL} ${EWDISPL}  
