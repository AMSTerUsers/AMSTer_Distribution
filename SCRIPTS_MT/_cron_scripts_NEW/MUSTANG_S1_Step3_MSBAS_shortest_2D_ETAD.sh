...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	#################
		...
		SET1=${PATH_1660}/SAR_SM/MSBAS/MUSTANG/set11
		SET2=${PATH_1660}/SAR_SM/MSBAS/MUSTANG/set12
...
#
	...
	###################################
		...
		# IW
		S1ASCIW=$PATH_3611/SAR_MASSPROCESS_ETAD/S1/MUSTANG_A_158/SMNoCrop_SM_${SMASC}_Zoom1_ML2
		S1DESCIW=$PATH_3611/SAR_MASSPROCESS_ETAD/S1/MUSTANG_D_19/SMNoCrop_SM_${SMDESC}_Zoom1_ML2

		# Path to LaunchParameters.txt files for each mode (need one for each mode)
		LAUNCHPARAMASCIW=LaunchMTparam_S1_Mustang_A_158_Zoom1_ML2_MassProc_0keep_ETAD.txt
		LAUNCHPARAMDESCIW=LaunchMTparam_S1_Mustang_D_19_Zoom1_ML2_MassProc_0keep_ETAD.txt
	...
	###########################################
		MSBASDIR=${PATH_3610}/MSBAS/_${LABEL}_S1_Auto_Max${MAXSHORT}Shortests_ETAD	
