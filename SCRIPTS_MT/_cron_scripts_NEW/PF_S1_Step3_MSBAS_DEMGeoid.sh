...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	###############
		...
		#specific to Reunion Island: second set of EVENTS for LandSlides for second set of points (LS)
		EVENTSLS=${PATH_1650}/EVENTS_TABLES/${LABEL}_LS
	...
	#################################################
		...
		#specific to Reunion Island: second set of points for LandSlides (LS) with second set of EVENTS (EVENTSLS)
		# List of SINGLE points for plotting time series with error bars  
		TIMESERIESPTSDESCRLS=${PATH_1650}/Data_Points/Points_TS_${LABEL}_LS.txt

		# List of PAIRS of points for plotting double difference (i.e. without error bar) in EW and UD, ASC and Desc... 
		# 	Note: if pixels are coherent in all modes, these can be the same list
		DOUBLEDIFFPAIRSEWUDLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSASCSMLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSDESCSMLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSASCIWLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSDESCIWLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSASCSMIWLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
		DOUBLEDIFFPAIRSDESCSMIWLS=${PATH_1650}/Data_Points/List_DoubleDiff_EW_UD_${LABEL}_LS.txt
...
# RePlot TS for LandSlides
##########################
		# Be sure being in MSBAS dir for ploting 
		cd ${MSBASDIR}
				
 

		# RePlot EW/UD
		# BACKUP EXISTING JPG IN COMBI BEFORE RUNNING REPLOT 
		mv "${MSBASDIR}/zz_UD_EW_TS_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_UD_EW_TS_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		
		Replot_EW_UD_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSEWUDLS}" "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"
		
		# RePlot LoS
		mv "${MSBASDIR}/zz_LOS_TS_SMAsc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_SMAsc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		Replot_LoS_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSASCSMLS}" SMAsc "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"

		mv "${MSBASDIR}/zz_LOS_TS_SMDesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_SMDesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		Replot_LoS_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSDESCSMLS}" SMDesc "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"

		mv "${MSBASDIR}/zz_LOS_TS_IWAsc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_IWAsc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		Replot_LoS_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSASCIWLS}" IWAsc "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"

		mv "${MSBASDIR}/zz_LOS_TS_IWDesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_IWDesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		Replot_LoS_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSDESCIWLS}" IWDesc "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"

		mv "${MSBASDIR}/zz_LOS_TS_SMIWasc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_SMIWasc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
		Replot_LoS_DoubleDiff_TS_From_Cron_Step3.sh "${DOUBLEDIFFPAIRSASCSMIWLS}" SMIWasc "_Auto_${ORDER}_${LAMBDA}_${LABEL}" "${EVENTSLS}"

		mv "${MSBASDIR}/zz_LOS_TS_SMIWdesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/__Combi/*.jpg "${MSBASDIR}/zz_LOS_TS_SMIWdesc_Auto_${ORDER}_${LAMBDA}_${LABEL}"/
