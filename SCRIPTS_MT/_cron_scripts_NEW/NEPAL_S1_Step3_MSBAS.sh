...
# New in Distro V 1.5:  - Debug dir naming for TS combination of modes 
# New in Distro V 1.6:  - Remove 3 modes combinations covering only a small triangle to the NW and already covered by 4 other combinations  
# New in Distro V 1.7:  - debug path to TS dirs
...
AUT="Nicolas d'Oreye, (c)2016-2019, Last modified on May 27, 2025"
...
#			
			...
			function RunCombiEWUD()
					...
					${PATH_SCRIPTS}/SCRIPTS_MT/MSBAS.sh _${MODES}_Auto_${ORDER}_${LAMBDA}_${LABEL} ${TIMESERIESPTS}
			...
			#${PATH_SCRIPTS}/SCRIPTS_MT/MSBAS.sh _${MODE02A}_${MODE01D}_Auto_${ORDER}_${LAMBDA}_${LABEL} ${TIMESERIESPTS}
