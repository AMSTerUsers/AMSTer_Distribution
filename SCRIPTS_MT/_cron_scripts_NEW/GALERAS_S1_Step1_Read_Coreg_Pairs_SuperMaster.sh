...
NEWASCPATH=$PATH_3610/SAR_SM/RESAMPLED/S1/GALERAS_A_120/SMNoCrop_SM_${SMASC1}
NEWDESCPATH=$PATH_3610/SAR_SM/RESAMPLED/S1/GALERAS_D_142/SMNoCrop_SM_${SMDESC1}
...
#Launch param files
PARAMCOREGASC=$PATH_1650/Param_files/S1/GALERAS_A_120/LaunchMTparam_S1_IW_Galeras_A_Zoom1_ML2_SuperMaster_Coreg.txt 
PARAMCOREGDESC=$PATH_1650/Param_files/S1/GALERAS_D_142/LaunchMTparam_S1_IW_Galeras_D_Zoom1_ML2_SuperMaster_Coreg.txt 
...
$PATH_SCRIPTS/SCRIPTS_MT/Read_All_Img.sh ${DIRSARDATA} ${DIRSARCSL}/NoCrop S1 ${KMLFILEASC} VV ${RESAMDIR} ${MASSPRODIR} EXACTKML > /dev/null 2>&1
...
_Check_ALL_S1_SizeAndCoord_InDir.sh ${DIRSARCSL}_A_120/NoCrop 3 "${KMLFILEASC}"  # valid for S1A
## needed for S1C 
_Check_ALL_S1_SizeAndCoord_InDir.sh ${DIRSARCSL}_A_120/NoCrop/__TMP_QUARANTINE 4 "${KMLFILEASC}"  # valid for S1A20250430, which for unknown reason, is offset and recorded 4 bursts 
