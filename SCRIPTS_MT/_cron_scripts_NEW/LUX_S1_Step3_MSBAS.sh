...
# New in Distro V 4.4.0 20251125 :	- always limited to 128 threads (see MAXTHREADS) to prevent problems with openblas, which is compiled by default for 128 threads 
# New in Distro V 4.5.0 2026730 :	- force msbasv4								
#
# AMSTer: SAR & InSAR Automated Mass processing Software for Multidimensional Time series
# NdO (c) 2016/03/07 - could make better with more functions... when time.
# -----------------------------------------------------------------------------------------
PRG=`basename "$0"`
VER="Distro V4.5.0 AMSTer script utilities"
...
# vvvvvvvvv Hard coded lines vvvvvvvvvvvvvv
	...
	###################################
		...
		S1ASC=${PATH_3610}/SAR_MASSPROCESS/S1/LUX_A_88/SMNoCrop_SM_20190406_Zoom1_ML2
		S1DESC=${PATH_3610}/SAR_MASSPROCESS/S1/LUX_D_139/SMNoCrop_SM_20210920_Zoom1_ML2
		...
		LAUNCHPARAMPATH=${PATH_DataSAR}/SAR_AUX_FILES/Param_files_SuperMaster/S1
		LAUNCHPARAMASC=${LAUNCHPARAMPATH}/LUX_A_88/LaunchMTparam_S1_LUX_A_88_Zoom1_ML2_MassProc_0keep.txt
		LAUNCHPARAMDESC=${LAUNCHPARAMPATH}/LUX_D_139/LaunchMTparam_S1_LUX_D_139_Zoom1_ML2_MassProc_0keep.txt
	...
	CRONJOB2=${PATHCRONJOB}/LUX_S1_Step2_MassProc.sh
...
# Remove lines in MSBAS/MODEi.txt file associated to possible broken links or duplicated lines with same name though wrong BP (e.g. after S1 orb update) 
		...
		_Check_bad_DefoInterpolx2Detrend.sh DefoInterpolx2Detrend1 ${PATH_3610}/SAR_MASSPROCESS &
		_Check_bad_DefoInterpolx2Detrend.sh DefoInterpolx2Detrend2 ${PATH_3610}/SAR_MASSPROCESS &
		wait
		...
		#Need also for the _Full ones (that is without coh threshold)
		if [ ${IFCOH} == "YES" ] ; then 
			_Check_bad_DefoInterpolx2Detrend.sh DefoInterpolx2Detrend1_Full ${PATH_3610}/SAR_MASSPROCESS &
			_Check_bad_DefoInterpolx2Detrend.sh DefoInterpolx2Detrend2_Full ${PATH_3610}/SAR_MASSPROCESS &
			wait
