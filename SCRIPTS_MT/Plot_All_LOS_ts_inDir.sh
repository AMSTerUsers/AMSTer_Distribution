#!/bin/bash
# -----------------------------------------------------------------------------------------
# This script is aiming at ploting all time series generated by (m)sbas2  or later that are in current dir
# 
# Parameters are : - none
#
...
#
# New in Distro V 1.0:	- Based on developpement version and Beta V1.
# New in Distro V 1.1:	- cope with more recent version of msbas
# New in Distro V 1.2:	- accounts for usage with msbasv4, i.e. that requires additional info in header files 
# New in Distro V 1.3:	- add creation date label
...
#	set output "lcurveNoLog.eps"
    ...
    set ylabel "LOS displacment [m]" font "Helvetica,24"
