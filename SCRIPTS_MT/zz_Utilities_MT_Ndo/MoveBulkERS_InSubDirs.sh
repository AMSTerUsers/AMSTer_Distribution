#!/bin/bash
# Script to move each of the raw ers files (named *.E1 or E2) in "new" ESA format from the current dir into subdirs named 
#  by their orbit number.
# 
# MUST BE LAUNCHED IN DIR CONTAINING ALL ERS FILES
#
# Parameters : - none  
#
