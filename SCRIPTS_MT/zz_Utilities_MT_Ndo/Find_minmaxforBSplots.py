...
## Load data
df = pd.read_csv(inputfile1, delimiter='\t', index_col=False, header=0, skipinitialspace=True)
image11=df.iloc[:,0]	
image12=df.iloc[:,1]

## Load data
df = pd.read_csv(inputfile2, delimiter='\t', index_col=False, header=0, skipinitialspace=True)
image21=df.iloc[:,0]	
image22=df.iloc[:,1]
