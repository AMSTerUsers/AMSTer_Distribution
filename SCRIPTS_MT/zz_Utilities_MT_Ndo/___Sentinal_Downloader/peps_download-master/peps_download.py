...
#
# This is a simple piece of code to automatically download the products provided by the French Sentinel collaborative ground segment named PEPS : https://peps.cnes.fr. 
# PEPS is mirroring all the Sentinel data provided by ESA, and is providing a simplified access.
# This code relies on python 2.7 **(however, a Python3 branch was created, which seems to work but was not much tested)**, and on the curl utility.
# See .../SCRIPTS_MT/zz_Utilities_MT_Ndo/___Sentinal_Downloader/peps_download-master/README.md
