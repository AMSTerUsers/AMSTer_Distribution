...
# for all the products (SLC, RESMAPLED, MASSPROCESSED) computed with a GIVEN 
# AMSTer Engine version (provided as a parameter) 
#
...
#
#
# New in Distro V 1.0 20250507:	- based on similar script searching for AE version before a given date 
#
...
AUT="Nicolas d'Oreye, (c)2016-2019, Last modified on May 07, 2026"
...
if [ $# -lt 2 ] ; then echo "Usage $0 DATE_AFTER_WHICH_PRODUCTS_PROCESSED_WITH_AMSTER_VERSION_IS_SEARCHED_FOR(i.e. yyyymmdd) TYPE_OF_PRODUCTS(i.e. CSL, COREG or PAIRS)"; exit; fi
