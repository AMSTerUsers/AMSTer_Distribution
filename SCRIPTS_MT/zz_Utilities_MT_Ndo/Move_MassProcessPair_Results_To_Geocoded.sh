...
# SAR_MASSPROCESS/SAT/TRK/SMCrop.../PRM_SCD/i12/GeoProjection 
...
SNGLPAIRDIRPATH=$1				# directory (with path) where the Pair was processed, i.e. in SAR_MASSPROCESS/SAT/TRK/SMCrop.../PRM_SCD
