...
${PATHGNU}/gawk 'NR==FNR { n[$1 $2]=($1 $2);next } ($1 $2 in n) { print $0 }' ${PAIRSFILE1} ${RESULTDIR}/allPairsListing.txt > ${RESULTDIR}/dataBaselinesPlot1.txt

echo "ComputeBaselinesPlotFile for file 2: ${PAIRSFILE2}"			
${PATHGNU}/gawk 'NR==FNR { n[$1 $2]=($1 $2);next } ($1 $2 in n) { print $0 }' ${PAIRSFILE2} ${RESULTDIR}/allPairsListing.txt > ${RESULTDIR}/dataBaselinesPlot2.txt


## FIND Min and Max values
echo " "
echo "Find common Min max values for all plots"
Find_minmaxforBSplots.py ${PAIRSFILE1} ${PAIRSFILE2} > ${RESULTDIR}/range_date.txt
...
#cd ${RESULTDIR}
${PATHGNU}/gawk 'NR==FNR { n[$1 $2]=($1 $2);next } ($1 $2 in n) { print $0 }' ${RESULTDIR}/pairs_in_file_1_only.txt ${RESULTDIR}/allPairsListing.txt > ${RESULTDIR}/dataBaselinesPlot_file1only.txt
...
${PATHGNU}/gawk 'NR==FNR { n[$1 $2]=($1 $2);next } ($1 $2 in n) { print $0 }' ${RESULTDIR}/pairs_in_file_2_only.txt ${RESULTDIR}/allPairsListing.txt > ${RESULTDIR}/dataBaselinesPlot_file2only.txt
...
${PATHGNU}/gawk 'NR==FNR { n[$1 $2]=($1 $2);next } ($1 $2 in n) { print $0 }' ${RESULTDIR}/pairs_in_both_tables.txt ${RESULTDIR}/allPairsListing.txt > ${RESULTDIR}/dataBaselinesPlot_commun.txt
...
num1=`${PATHGNU}/gsed -n '$=' ${PAIRSFILE1} `
NBPAIRS1=`echo ${num1}-2 | bc`
echo ${NBPAIRS1} " pairs found in File " ${PAIRSFILE1}

num1=`${PATHGNU}/gsed -n '$=' ${PAIRSFILE2}`
NBPAIRS2=`echo ${num1}-2 | bc`
echo ${NBPAIRS2} " pairs found in File " ${PAIRSFILE2}

num1=`${PATHGNU}/gsed -n '$=' ${RESULTDIR}/pairs_in_file_1_only.txt`
NBPAIRSonly1=`echo ${num1}-2 | bc`
echo ${NBPAIRSonly1} " pairs are only in File " ${PAIRSFILE1}

num1=`${PATHGNU}/gsed -n '$=' ${RESULTDIR}/pairs_in_file_2_only.txt`
NBPAIRSonly2=`echo ${num1}-2 | bc`
echo ${NBPAIRSonly2} " pairs are only in File " ${PAIRSFILE2}

num1=`${PATHGNU}/gsed -n '$=' ${RESULTDIR}/pairs_in_both_tables.txt`
NBPAIRScom=`echo ${num1}-2 | bc`
